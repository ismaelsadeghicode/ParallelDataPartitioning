...
public class ParallelRedistributionMergeAllService<T> extends ParallelSortService<T> {
    ...
    public ParallelRedistributionMergeAllService(Storage<T> storage, List<Cpu<T>> cpus, Comparator<? super T> comparator) {
